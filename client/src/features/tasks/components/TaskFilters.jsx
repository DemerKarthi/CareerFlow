...
import { TASK_STATUS, TASK_PRIORITY, TASK_TYPE } from '../constants';

export const TaskFilters = ({ filters, onFilterChange, onSearchChange, applications }) => {
  return (
    <div className="flex flex-col space-y-4 mb-6 bg-white dark:bg-slate-900 p-4 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm">
      ...
      <div className="flex flex-col lg:flex-row gap-4">
        ...
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder="Search tasks, jobs, companies..."
        ...
        {/* Filters */}
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 lg:flex-[1.5]">
          <select
